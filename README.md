...
- เมนู "ฝ่ายโรงงาน" ฝั่งซ้ายเปิดให้เลือก 8 แผนกของโรงงาน (RB, GR, PT, BG, PK, ST, SR, WH)
  ทั้งจากเมนูย่อยด้านซ้ายและการ์ดเลือกแผนกในหน้าโมดูล เลือกแผนกแล้วจะเปิดพื้นที่ทำงานของแผนกนั้น
  ซึ่งรวมรายการ BOM ที่ผูกกับแผนก ขั้นตอนผลิตของแผนก และลิงก์เครื่องมือของแผนก
  ชื่อไทยของแผนกตั้งได้เองจากหน้าแผนก (มีแต่ RB ที่ตั้งชื่อไว้ให้ ส่วนที่เหลือรอผู้ใช้ระบุ)
